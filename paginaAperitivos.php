                ...
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center">
                            <h1 class="mb-0 pt-3 display-4 text-white text-uppercase font-weight-bold">menú de aperitivos</h1>                            
                    ...
                    <div class="row justify-content-around align-items-center text-white border-bottom border-white py-3">
                        <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-2">
                            <img src="imgAperitivos/aperitivos_1.png" class="imgPlato img-fluid mx-auto d-block" alt="imagen alitas de pollo"/>
                        </div>
                        <div class="col-7 col-sm-7 col-md-7 col-lg-7 col-xl-2">
                        ...
                        <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                            <p class="mb-0"><i class="fa-solid fa-cedi-sign mr-2"></i>00,000.00</p>
                        </div>
                        
                        <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-2">
                            <img src="imgAperitivos/aperitivos_2.png" class="imgPlato img-fluid mx-auto d-block" alt="imagen alitas de pollo bbq"/>
                        </div>
                        <div class="col-7 col-sm-7 col-md-7 col-lg-7 col-xl-2">
                            <h6 class="font-weight-bold text-uppercase">Lorem ipsum dolor sit amet</h6>
                            <p class="mb-0">Cras tempor molestie mauris, ut pretium lectus ornare id. Vestibulum condimentum, ligula et lacinia pulvinar, urna tellus viverra justo.</p>
                    ...
                    <div class="row justify-content-around align-items-center text-white border-bottom border-white py-3">
                        <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-2">
                            <img src="imgAperitivos/aperitivos_3.png" class="imgPlato img-fluid mx-auto d-block" alt="imagen alitas de pollo"/>
                        </div>
                        <div class="col-7 col-sm-7 col-md-7 col-lg-7 col-xl-2">
                            <h6 class="font-weight-bold text-uppercase">Lorem ipsum dolor sit amet</h6>
                            <p class="mb-0">Cras tempor molestie mauris, ut pretium lectus ornare id. Vestibulum condimentum, ligula et lacinia pulvinar, urna tellus viverra justo.</p>
                        ...
                        <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-2">
                            <img src="imgAperitivos/aperitivos_4.png" class="imgPlato img-fluid mx-auto d-block" alt="imagen alitas de pollo bbq"/>
                        </div>
                        <div class="col-7 col-sm-7 col-md-7 col-lg-7 col-xl-2">
                            <h6 class="font-weight-bold text-uppercase">Lorem ipsum dolor sit amet</h6>
                            <p class="mb-0">Cras tempor molestie mauris, ut pretium lectus ornare id. Vestibulum condimentum, ligula et lacinia pulvinar, urna tellus viverra justo.</p>
                    ...
                    <div class="row justify-content-around align-items-center text-white border-bottom border-white py-3">
                        <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-2">
                            <img src="imgAperitivos/aperitivos_5.png" class="imgPlato img-fluid mx-auto d-block" alt="imagen alitas de pollo"/>
                        </div>
                        <div class="col-7 col-sm-7 col-md-7 col-lg-7 col-xl-2">
                            <h6 class="font-weight-bold text-uppercase">Lorem ipsum dolor sit amet</h6>
                            <p class="mb-0">Cras tempor molestie mauris, ut pretium lectus ornare id. Vestibulum condimentum, ligula et lacinia pulvinar, urna tellus viverra justo.</p>
                        ...
                        <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-2">
                            <img src="imgAperitivos/aperitivos_6.png" class="imgPlato img-fluid mx-auto d-block" alt="imagen alitas de pollo bbq"/>
                        </div>
                        <div class="col-7 col-sm-7 col-md-7 col-lg-7 col-xl-2">
                            <h6 class="font-weight-bold text-uppercase">Lorem ipsum dolor sit amet</h6>
                            <p class="mb-0">Cras tempor molestie mauris, ut pretium lectus ornare id. Vestibulum condimentum, ligula et lacinia pulvinar, urna tellus viverra justo.</p>
                    ...
                    <div class="row justify-content-around align-items-center text-white border-bottom border-white py-3">
                        <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-2">
                            <img src="imgAperitivos/aperitivos_7.png" class="imgPlato img-fluid mx-auto d-block" alt="imagen alitas de pollo"/>
                        </div>
                        <div class="col-7 col-sm-7 col-md-7 col-lg-7 col-xl-2">
                            <h6 class="font-weight-bold text-uppercase">Lorem ipsum dolor sit amet</h6>
                            <p class="mb-0">Cras tempor molestie mauris, ut pretium lectus ornare id. Vestibulum condimentum, ligula et lacinia pulvinar, urna tellus viverra justo.</p>
                        ...
                        <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-2">
                            <img src="imgAperitivos/aperitivos_8.png" class="imgPlato img-fluid mx-auto d-block" alt="imagen alitas de pollo bbq"/>
                        </div>
                        <div class="col-7 col-sm-7 col-md-7 col-lg-7 col-xl-2">
                            <h6 class="font-weight-bold text-uppercase">Lorem ipsum dolor sit amet</h6>
                            <p class="mb-0">Cras tempor molestie mauris, ut pretium lectus ornare id. Vestibulum condimentum, ligula et lacinia pulvinar, urna tellus viverra justo.</p>
