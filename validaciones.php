<?php
    ...
    if(isset($_POST['nombre'])) {
        ...
        // Verifica si el campo 'mensaje' está vacío
        if(empty(filter_input(INPUT_POST, 'mensaje'))) {
            echo "<p class='error'><i class='fas fa-exclamation-triangle'></i>&nbsp;&nbsp;Campo obligatorio. Agrega tu comentario</p>";                 
        } 
        
        // Verifica que los datos ingresados en este campo cumplan con la cantidad mínima de caracteres especificada
        else if(strlen(filter_input(INPUT_POST, 'mensaje')) < 10) {
            echo "<p class='error'><i class='fas fa-exclamation-triangle'></i>&nbsp;&nbsp;Error: Debes agregar un comentarion</p>";
        }
        
        // Si se cumplió con la regla solicitada se muestra un mensaje de exito
        else {
            echo "<p class='correcto'><i class='fas fa-check'></i>&nbsp;&nbsp;Escribiste tu mensaje de forma correcta</p>";
        }
