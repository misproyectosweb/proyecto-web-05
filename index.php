        ...
        <main>
            <div id="inicio" class="inicio imagenFondo">
                <div class="container-fluid border-bottom border-danger">
                    <div class="row">
                        <div class="jumbotron jumbotron-fluid colorFondo border border-white rounded-pill text-center text-white">
            ...
            <div id="especialidades" class="especialidades border-bottom border-danger bg-light">
                <div class="row col-5 col-sm-5 col-md-5 col-lg-5 col-xl-5 justify-content-center mx-auto pt-4" >
                    <img src="imgInicio/lineaDecorativa_1.png" class="img-fluid" alt=""/>
                </div>
                
                <h1 class="my-1 font-weight-bold text-center text-danger">Nuestras especialidades</h1>
                
                <div class="row col-5 col-sm-5 col-md-5 col-lg-5 col-xl-5 justify-content-center mx-auto pb-4">
                    <img src="imgInicio/lineaDecorativa_2.png" class="img-fluid" alt=""/>
                </div>
                <div class="container-fluid">
                    <div class="row justify-content-around">
                        <div class="card col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 border-danger m-2 p-2">
                            ...
                            <div class="card-footer bg-white border-top-0 px-2">
                                <a href="paginaAperitivos.php" class="boton btn btn-outline-danger font-weight-bold">Ir al menú</a>
                            </div>
                        </div>
                        <div class="card col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 border-danger m-2 p-2">
                            ...
                            <div class="card-footer bg-white border-top-0 px-2">
                                <a href="paginaPizzas.php" class="boton btn btn-outline-danger font-weight-bold">Ir al menú</a>
                            </div>
                        </div>
                        <div class="card col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 border-danger m-2 p-2">
                            ...
                            <div class="card-footer bg-white border-top-0 px-2">
                                <a href="paginaPastas.php" class="boton btn btn-outline-danger font-weight-bold">Ir al menú</a>
                            </div>
                        </div>
                        <div class="card col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 border-danger m-2 p-2">
                            ...
                            <div class="card-footer bg-white border-top-0 px-2">
                                <a href="paginaHamburguesas.php" class="boton btn btn-outline-danger font-weight-bold">Ir al menú</a>
                            </div>
                        </div>
                        <div class="card col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 border-danger m-2 p-2">
                            ...
                            <div class="card-footer bg-white border-top-0 px-2">
                                <a href="paginaBebidas.php" class="boton btn btn-outline-danger font-weight-bold">Ir al menú</a>
                            </div>
                        </div>
                        <div class="card col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 border-danger m-2 p-2">
                            ...
                            <div class="card-footer bg-white border-top-0 px-2">
                                <a href="paginaPostres.php" class="boton btn btn-outline-danger font-weight-bold">Ir al menú</a>
                            </div>
                        </div>
                    </div>
            ...
            <div id="historia" class="historia border-bottom border-danger">
                <div class="row col-6 col-sm-6 col-md-6 col-lg-4 col-xl-5 justify-content-center mx-auto pt-4" >
                    <img src="imgInicio/lineaDecorativa_3.png" class="img-fluid" alt=""/>
                </div>
                
                <h1 class="my-1 font-weight-bold text-center text-white">Conozca nuestra historia</h1>
                
                <div class="row col-6 col-sm-6 col-md-6 col-lg-4 col-xl-5 justify-content-center mx-auto pb-4">
            ...
            <div class="container-fluid border-bottom border-danger">
                ...
                <div class="row justify-content-center">
                    <div class="carrusel col-12 col-sm-12 col-md-12 col-lg-9 col-xl-8 py-5">
