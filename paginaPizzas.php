                ...
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center">
                            <h1 class="mb-0 pt-3 display-4 text-white text-uppercase font-weight-bold">menú de pizzas</h1>                            
                    ...
                    <div class="row">
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6 d-flex flex-row justify-content-around align-items-center rounded-top pt-5" style="background-color: rgba(221, 203, 161, 0.9);">
                            ...
                            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 d-flex flex-column">
                                <img src="imgPizzas/pizza_1.png" class="imgPizza img-fluid mx-auto d-block" alt=""/>
                            </div>                                                         
                        </div>
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6"></div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6 d-flex flex-row justify-content-around align-items-center pt-5" style="background-color: rgba(221, 203, 161, 0.9);">
                            ...
                            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 d-flex flex-column">
                                <img src="imgPizzas/pizza_2.png" class="imgPizza img-fluid mx-auto d-block" alt=""/>
                            </div>                                                         
                        </div>
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6"></div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6 d-flex flex-row justify-content-around align-items-center pt-5" style="background-color: rgba(221, 203, 161, 0.9);">
                            ...
                            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 d-flex flex-column">
                                <img src="imgPizzas/pizza_3.png" class="imgPizza img-fluid mx-auto d-block" alt=""/>
                            </div>                                                         
                        </div>
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6"></div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6 d-flex flex-row justify-content-around align-items-center pt-5" style="background-color: rgba(221, 203, 161, 0.9);">
                            ...
                            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 d-flex flex-column">
                                <img src="imgPizzas/pizza_4.png" class="imgPizza img-fluid mx-auto d-block" alt=""/>
                            </div>                                                         
                        </div>
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6"></div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6 d-flex flex-row justify-content-around align-items-center pt-5" style="background-color: rgba(221, 203, 161, 0.9);">
                            ...
                            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 d-flex flex-column">
                                <img src="imgPizzas/pizza_5.png" class="imgPizza img-fluid mx-auto d-block" alt=""/>
                            </div>                                                         
                        </div>
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6"></div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6 d-flex flex-row justify-content-around align-items-center pt-5" style="background-color: rgba(221, 203, 161, 0.9);">
                            ...
                            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 d-flex flex-column">
                                <img src="imgPizzas/pizza_6.png" class="imgPizza img-fluid mx-auto d-block" alt=""/>
                            </div>                                                         
                        </div>
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6"></div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6 d-flex flex-row justify-content-around align-items-center pt-5" style="background-color: rgba(221, 203, 161, 0.9);">
                            ...
                            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 d-flex flex-column">
                                <img src="imgPizzas/pizza_7.png" class="imgPizza img-fluid mx-auto d-block" alt=""/>
                            </div>                                                         
                        </div>
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6"></div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6 d-flex flex-row justify-content-around align-items-center pt-5" style="background-color: rgba(221, 203, 161, 0.9);">
                            ...
                            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 d-flex flex-column">
                                <img src="imgPizzas/pizza_8.png" class="imgPizza img-fluid mx-auto d-block" alt=""/>
                            </div>                                                         
                        </div>
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6"></div>
                    </div>
                    ...
                    <div class="row mb-5">
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6 d-flex flex-row justify-content-around align-items-center rounded-bottom py-5" style="background-color: rgba(221, 203, 161, 0.9);">
                            ...
                            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 d-flex flex-column">
                                <img src="imgPizzas/pizza_9.png" class="imgPizza img-fluid mx-auto d-block" alt=""/>
                            </div>                                                         
                        </div>
                        <div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-6"></div>
                    </div>                                        
