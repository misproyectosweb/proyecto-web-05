<?php
    ...
    if (isset ($_POST['nombre']) && !empty ($_POST['nombre']) && 
        isset ($_POST['telcasa']) && !empty($_POST['telcasa']) && 
        ...
        isset ($_POST['mensaje']) && !empty($_POST['mensaje'])) 
    {
        ...
        $mensajeCorreo = "Nombre: " . $nombre . "<br>Teléfono casa: " . $telcasa . "<br>Teléfono celular: " . $telcelular . "<br>Correo: " . $correo .
                         "<br>Dirección: " . $direccion . "<br><br>Comentario sobre tu experiencia:" . "<br>" . $mensaje;
