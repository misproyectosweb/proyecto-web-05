        ...
        <main>
            <div id="menuHamburguesas" class="menuHamburguesas colorFondo">
                <div class="container-fluid">
                    ...
                    <!-- Hamburguesas -->
                    <div class="row mx-1 border border-white rounded-lg mt-3"> 
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 justify-content-center">
                            <h3 class="text-center text-dark my-5 py-2 border border-warning rounded-pill bg-warning mx-auto">Hamburguesas</h3>                       
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex flex-row justify-content-around">                                                                 
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-white pt-4">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex flex-row justify-content-around align-items-center">
                                <div class="col-6 col-sm-6 col-md-6 col-lg-5 col-xl-4 align-items-center border border-dark-50 rounded-lg pb-3">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <img src="imgHamburguesas/hamburguesa_1.png" class="imgHamburguesa img-fluid mx-auto d-block" alt="imagen hamburguesa de carne"/>
                                    </div>                                    
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <p class="precio mb-0 text-right"><i class="fa-solid fa-cedi-sign mr-2"></i>00,000.00</p>
                                    </div>
                                </div>
                                <div class="col-6 col-sm-6 col-md-6 col-lg-5 col-xl-4 align-items-center border border-dark-50 rounded-lg pb-3">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <img src="imgHamburguesas/hamburguesa_2.png" class="imgHamburguesa img-fluid mx-auto d-block" alt="imagen hamburguesa de carne"/>
                                    </div>                                    
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <h6 class="font-weight-bold text-uppercase">Lorem ipsum dolor sit amet</h6>
                                        <p class="mb-0 text-justify">Cras tempor molestie mauris, ut pretium lectus ornare id. Vestibulum condimentum, ligula et lacinia pulvinar, urna tellus viverra justo.</p>
                    ...
                    <div class="row mx-1 border border-white rounded-lg my-3"> 
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 justify-content-center">
                            <h3 class="text-center text-dark my-5 py-2 border border-warning rounded-pill bg-warning mx-auto">Sandwiches</h3>                       
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex flex-row justify-content-around">                                                                 
                                <div class="col-6 col-sm-6 col-md-6 col-lg-5 col-xl-5">                                                                
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-white pt-4">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex flex-row justify-content-around align-items-center">
                                <div class="col-6 col-sm-6 col-md-6 col-lg-5 col-xl-4 align-items-center border border-dark-50 rounded-lg pb-3">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <img src="imgHamburguesas/sandwiches_1.png" class="imgHamburguesa img-fluid mx-auto d-block" alt="imagen sandwich de carne"/>
                                    </div>                                    
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <h6 class="font-weight-bold text-uppercase">Lorem ipsum dolor sit amet</h6>
                                        <p class="mb-0 text-justify">Cras tempor molestie mauris, ut pretium lectus ornare id. Vestibulum condimentum, ligula et lacinia pulvinar, urna tellus viverra justo.</p>
                                ...
                                <div class="col-6 col-sm-6 col-md-6 col-lg-5 col-xl-4 align-items-center border border-dark-50 rounded-lg pb-3">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <img src="imgHamburguesas/sandwiches_2.png" class="imgHamburguesa img-fluid mx-auto d-block" alt="imagen sandwich de pollo"/>
                                    </div>                                    
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <h6 class="font-weight-bold text-uppercase">Lorem ipsum dolor sit amet</h6>
                                        <p class="mb-0 text-justify">Cras tempor molestie mauris, ut pretium lectus ornare id. Vestibulum condimentum, ligula et lacinia pulvinar, urna tellus viverra justo.</p>
                    ...
                    <div class="row mx-1 border border-white rounded-lg"> 
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 justify-content-center">
                            <h3 class="text-center text-dark my-5 py-2 border border-warning rounded-pill bg-warning mx-auto">Otras especialidades</h3>                       
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex flex-row justify-content-around">                                                                 
                                <div class="col-6 col-sm-6 col-md-6 col-lg-5 col-xl-5">                                                                
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-white pt-4">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex flex-row justify-content-around align-items-center">
                                <div class="col-6 col-sm-6 col-md-6 col-lg-5 col-xl-4 align-items-center border border-dark-50 rounded-lg pb-3">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <img src="imgHamburguesas/hotdog_1.png" class="imgHamburguesa img-fluid mx-auto d-block" alt="imagen de un hotdog"/>
                                    </div>                                    
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <h6 class="font-weight-bold text-uppercase">Lorem ipsum dolor sit amet</h6>
                                        <p class="mb-0 text-justify">Cras tempor molestie mauris, ut pretium lectus ornare id. Vestibulum condimentum, ligula et lacinia pulvinar, urna tellus viverra justo.</p>
                                ...
                                <div class="col-6 col-sm-6 col-md-6 col-lg-5 col-xl-4 align-items-center border border-dark-50 rounded-lg pb-3">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <img src="imgHamburguesas/sandwiches_3.png" class="imgHamburguesa img-fluid mx-auto d-block" alt="imagen de un emparedado"/>
                                    </div>                                    
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <h6 class="font-weight-bold text-uppercase">Lorem ipsum dolor sit amet</h6>
                                        <p class="mb-0 text-justify">Cras tempor molestie mauris, ut pretium lectus ornare id. Vestibulum condimentum, ligula et lacinia pulvinar, urna tellus viverra justo.</p>
